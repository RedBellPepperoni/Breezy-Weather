...
export const WeatherForecast = ({data}: WeatherForecastProps) => {
    ...
    const dailyForecastList = data.list.reduce((acc,forecast) => {
    ...
    const nextDayList = Object.values(dailyForecastList).slice(0,6);
                        ...
                        return (<div key={day.date} className="grid grid-cols-3 items-center gap-4 rounded-lg border p-4">
                            ...
                            <div className="flex justify-end gap-4">
                                ...
                                <span className="flex items-center gap-1">
                                    ...
                                    <span className="text-sm">{getWindSpeed_KMPH(day.wind)} km/h</span>
                                </span>
